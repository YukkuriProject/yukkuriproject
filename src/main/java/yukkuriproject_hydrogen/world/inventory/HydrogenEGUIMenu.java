...
package yukkuriproject_hydrogen.world.inventory;
...
public class HydrogenEGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public HydrogenEGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(YukkuriprojectModMenus.HYDROGEN_EGUI.get(), id);
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 16, 53) {
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 142, 53) {
